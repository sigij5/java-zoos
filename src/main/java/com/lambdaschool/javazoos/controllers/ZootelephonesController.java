...
//import com.lambdaschool.usermodel.services.ZootelephoneService;
...
//public class ZootelephonesController
//{
//    /**
//     * Using the Zootelephone service to process user, email combinations data
//     */
//    @Autowired
//    ZootelephoneService zootelephoneService;
//
//    /**
...
//    {
//        List<Zootelephone> allUserEmails = zootelephoneService.findAll();
...
//                    Long useremailId)
//    {
//        Zootelephone ue = zootelephoneService.findUseremailById(useremailId);
...
//                    long useremailid)
//    {
//        zootelephoneService.delete(useremailid);
...
//                    String emailaddress)
//    {
//        zootelephoneService.update(useremailid,
//                                emailaddress);
//        return new ResponseEntity<>(HttpStatus.OK);
//    }
//
...
//     * @see ZootelephoneService#save(long, String) ZootelephoneService.save(long, String)
//     */
...
//            URISyntaxException
//    {
//        Zootelephone newUserEmail = zootelephoneService.save(userid,
//                                                       emailaddress);
//
